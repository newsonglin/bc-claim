...
curl -s -X POST \
  ...
  -H "content-type: application/json" \
  -d '{
	"peers": ["peer0.org2.exigen.com","peer1.org2.exigen.com"]
}'
echo
echo
...
echo
curl -s -X GET http://localhost:4000/channels/mychannel/transactions/$TRX_ID?peer=peer0.org1.exigen.com \
  -H "authorization: Bearer $ORG1_TOKEN" \
  -H "content-type: application/json"
echo
echo
...
echo
curl -s -X GET \
  "http://localhost:4000/chaincodes?peer=peer0.org1.exigen.com" \
  -H "authorization: Bearer $ORG1_TOKEN" \
  -H "content-type: application/json"
echo
echo
...
echo
curl -s -X GET \
  "http://localhost:4000/channels/mychannel/chaincodes?peer=peer0.org1.exigen.com" \
  -H "authorization: Bearer $ORG1_TOKEN" \
  -H "content-type: application/json"
echo
echo
